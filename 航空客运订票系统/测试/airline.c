...
Status OutAirline()//存储航线信息
{
	...
	fprintf(fp,"序号,出发地,抵达地,航班号,航空公司,飞机号,起步价,载客量,头等舱,商务舱,经济舱,起飞机场,降落机场,月,日,星期,时,分,抵达时,抵达分\n");
...
Status PrintAirline(Airline *A)//打印航线信息
{
    ...
    printf("%02d月%02d号\t%02d:%02d\t\t%02d:%02d\t\t",A->month,A->day,A->hour,A->min,A->nexthour,A->nextmin);
